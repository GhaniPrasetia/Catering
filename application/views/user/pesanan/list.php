            ...
            <div class="card rounded border border-warning bg_custom">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <?php if ($status == 1) : ?>
                            <button onclick="bayar_sekarang('<?= $key->id ?>');" class="btn fw-600 btn-warning">BAYAR SEKARANG</button>
                            <button onclick="update_status('<?= $key->id ?>','4', 'batalkan pesanan');" class="btn fw-600 btn-light">BATALKAN</button>
                        <?php endif; ?>
