...
<script>
    ...
    function load_all() {
        $.ajax({
            type: "POST",
            url: "<?= base_url('user/menu_list/getAll') ?>",
            data: {},
            dataType: "JSON",
            beforeSend: function() {
                Swal.fire({
    ...
    function pesan_now(type, id) {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url('user/menu_list/order') ?>",
            data: {
                type: type,
                id: id,
                qty: now,
    ...
    function keranjang() {
        $.ajax({
            type: "POST",
            url: "<?= base_url('user/menu_list/keranjang') ?>",
            dataType: "JSON",
            data: {},
    ...
    function batalkan(id) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('user/menu_list/batalkan') ?>",
                    data: {
                        id: id,
                    },
                    dataType: "JSON",
    ...
    function proses_pesanan() {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('user/menu_list/proses_pesanan') ?>",
                    data: {
                        id: true,
                    },
                    dataType: "JSON",
